...
import com.ramlawi.notes.feature_notes.presentation.notes.components.NoteItem
...
fun NotesScreen(
    ...
    val scaffoldState =  rememberScaffoldState() // to show snakeBars
    val scope = rememberCoroutineScope()  // for showing snakeBar also
